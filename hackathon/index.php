          ...
          <div id="a">
            ...
            <div id="article">
              ...
              <div class="ats" style="margin-top: 1vw;">
                  ...
                  <h1 style="background-color: rgba(0,0,0,0.2); border-radius: 50px; text-align: center;"><?php echo $key['heading']; ?></h1>

                  <p><?php echo $key['time_of_article'] ?> -- <?php echo $key['author'] ?></p>
